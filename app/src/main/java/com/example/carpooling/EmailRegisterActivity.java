        ...
        buttonReg.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(TextUtils.isEmpty(email)){
                    Toast.makeText(EmailRegisterActivity.this, "Enter workplace Email id", Toast.LENGTH_SHORT).show();
                    return;
                }
                ...
                if(email.contains("@gmail.com") || email.contains("@yahoo.com") || email.contains("@rediffmail.com")){
                    Toast.makeText(EmailRegisterActivity.this, "Enter workplace Email id", Toast.LENGTH_SHORT).show();
                    return;
                }
